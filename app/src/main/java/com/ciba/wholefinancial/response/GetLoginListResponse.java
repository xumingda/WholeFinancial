 ...
 * @更新内容: TODO
 */
public class GetLoginListResponse {
	...
	public List<BusinessLoginBean>  dataList;
	...
	public List<BusinessLoginBean> getDataList() {
		return dataList;
	}

	public void setDataList(List<BusinessLoginBean> dataList) {
