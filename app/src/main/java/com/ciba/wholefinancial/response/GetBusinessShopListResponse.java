 ...
 * @更新内容: TODO
 */
public class GetBusinessShopListResponse {
	...
	public List<BusinessShopBean>  dataList;
	...
	public List<BusinessShopBean> getDataList() {
		return dataList;
	}

	public void setDataList(List<BusinessShopBean> dataList) {
