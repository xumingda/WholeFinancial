...
public class PrintProtocol extends BaseProtocol<AddOrUpdateLoginResponse> {
	...
	protected AddOrUpdateLoginResponse parseJson(String json) {
		AddOrUpdateLoginResponse getcoderesponse = gson.fromJson(json, AddOrUpdateLoginResponse.class);
