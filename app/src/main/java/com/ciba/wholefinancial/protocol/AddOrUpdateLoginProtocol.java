...
public class AddOrUpdateLoginProtocol extends BaseProtocol<AddOrUpdateLoginResponse> {
	protected static final String TAG = "DiscoveryByProtocol";
	private Gson gson;

	public AddOrUpdateLoginProtocol() {
		gson = new Gson();
	}
	...
	public String getApiFun() {
		...
		return "/business/addOrUpdateBusinessLogin";
	}
