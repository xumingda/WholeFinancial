...
public class UpdateMemberLevelProtocol extends BaseProtocol<UpdateMarketingResponse> {
	protected static final String TAG = "DiscoveryByProtocol";
	private Gson gson;

	public UpdateMemberLevelProtocol() {
		gson = new Gson();
	}
	...
	public String getApiFun() {
		...
		return "/business/addOrUpdateBusinessLevel";
	}
