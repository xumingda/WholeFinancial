...
public class AddBusinessShopCodeProtocol extends BaseProtocol<AddOrUpdateLoginResponse> {
	protected static final String TAG = "DiscoveryByProtocol";
	private Gson gson;

	public AddBusinessShopCodeProtocol() {
		gson = new Gson();
	}
	...
	public String getApiFun() {
		...
		return "/business/addBusinessShopCode";
	}
