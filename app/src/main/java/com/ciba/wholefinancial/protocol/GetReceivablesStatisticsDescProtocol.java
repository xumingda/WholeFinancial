...
public class GetReceivablesStatisticsDescProtocol extends BaseProtocol<GetGoodsListResponse> {
	protected static final String TAG = "DiscoveryByProtocol";
	private Gson gson;

	public GetReceivablesStatisticsDescProtocol() {
		gson = new Gson();
	}
	...
	public String getApiFun() {
		...
		return "/salesman/receivablesStatisticsDesc";
	}
