...
public class SubmitBusinessInfoProtocol extends BaseProtocol<SubmitBusinessInfoResponse> {
	protected static final String TAG = "DiscoveryByProtocol";
	private Gson gson;

	public SubmitBusinessInfoProtocol() {
		gson = new Gson();
	}
	...
	public String getApiFun() {
		...
		return "/salesman/submitBusinessInfo";
	}
