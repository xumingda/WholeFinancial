...
//会员管理
public class AttendListsActivity extends BaseActivity implements View.OnClickListener,PullToRefreshBase.OnRefreshListener{

    private LayoutInflater mInflater;
    private View rootView;


    private View view_back,view_record;
    ...
    private void initDate() {
        ...
        loadingDialog = DialogUtils.createLoadDialog(AttendListsActivity.this, false);
        ...
        lv_member.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent=new Intent(AttendListsActivity.this, AttendActivity.class);
        ...
        view_record.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    Intent intent=new Intent(AttendListsActivity.this, HistoryAttendListsActivity.class);
    ...
    private void setData() {
        ...
        if (clockAdapter == null) {
            clockAdapter = new ClockAdapter( AttendListsActivity.this, clockBeanList);
    ...
    public void getClockList() {
        ...
        MyVolley.uploadNoFile(MyVolley.POST, url, params, new MyVolley.VolleyCallback() {
                ...
                if (getClocktListResponse.code == 0) {
                    if(getClocktListResponse.getDataList().size()>0){
                        ...
                        if (getClocktListResponse.getDataList().size() > 0) {
                            ...
                            DialogUtils.showAlertDialog(AttendListsActivity.this, "没有更多数据了！");
                        }
                    }else {
                    ...
                    if(getClocktListResponse.msg.indexOf("此账号在其他地方登陆")!=-1){

                        DialogUtils.showAlertToLoginDialog(AttendListsActivity.this,
                                getClocktListResponse.msg);
                    }else{
                        DialogUtils.showAlertDialog(AttendListsActivity.this, getClocktListResponse.msg);
                    }
            ...
            public void dealWithError(String address, String error) {
                loadingDialog.dismiss();
                DialogUtils.showAlertDialog(AttendListsActivity.this, error);
                if (isRefresh) {
                    isRefresh = false;
                    lv_member.onRefreshComplete();
                }
