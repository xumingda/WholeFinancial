...
public class AddImageNewAdapter extends BaseAdapter {
    ...
    public AddImageNewAdapter(Context context, List<Bitmap> bitmapList, OnShowCallBack onShowCallBack, List<String> pics) {
        mContext = context;
