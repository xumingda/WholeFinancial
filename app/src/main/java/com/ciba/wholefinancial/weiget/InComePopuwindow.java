...
import com.ciba.wholefinancial.adapter.IncomePopAdapter;
import com.ciba.wholefinancial.adapter.SpinnerPopAdapter;

import java.util.List;

public class InComePopuwindow extends PopupWindow {

    private View conentView;
    private ListView listView;
    private IncomePopAdapter adapter;
    ...
    public InComePopuwindow(final Activity context, final String string, final List<String> list, AdapterView.OnItemClickListener itemsOnClick) {
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        this.context =context;
        conentView = inflater.inflate(R.layout.income_popuwindow, null);
        ...
        adapter = new IncomePopAdapter(context,list,string);
