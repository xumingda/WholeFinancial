...
public class ClockOutPopuwindow extends PopupWindow {
    ...
    public ClockOutPopuwindow(final Activity context,final OnSetViewCallBack onSetViewCallBack) {
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        this.context =context;
        conentView = inflater.inflate(R.layout.clock_out_layout, null);
