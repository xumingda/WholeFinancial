...
import com.ciba.wholefinancial.adapter.SelectShopAdapter;
import com.ciba.wholefinancial.adapter.SpinnerPopAdapter;

import java.util.List;

public class SelectShopPopuwindow extends PopupWindow {
    ...
    public SelectShopPopuwindow(final Activity context, final String string, final List<String> list, AdapterView.OnItemClickListener itemsOnClick) {
