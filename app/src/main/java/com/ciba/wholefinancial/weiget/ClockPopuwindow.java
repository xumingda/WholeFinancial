...
public class ClockPopuwindow extends PopupWindow {
    ...
    public ClockPopuwindow(final Activity context, final OnSetViewCallBack onSetViewCallBack) {
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        this.context =context;
        conentView = inflater.inflate(R.layout.clock_in_layout, null);
        ...
        tv_commit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dismiss();
                darkenBackground(1f);
                onSetViewCallBack.CallBackSuccess(0);
            }
        });
        Date d = new Date();
        SimpleDateFormat sdf_time = new SimpleDateFormat("HH:mm:ss");
        tv_time.setText(sdf_time.format(d));
    }
