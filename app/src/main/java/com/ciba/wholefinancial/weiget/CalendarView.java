...
import com.ciba.wholefinancial.util.SolarUtil;
...
public class CalendarView extends ViewPager {
    ...
    public void goLastYear(int count) {
        if (currentPosition - 12 >= 0) {
            setCurrentItem(currentPosition -= 12*count, false);
        }
    }
    public void goNextYear(int count) {
        if (currentPosition + 12 >= 0) {
            setCurrentItem(currentPosition += 12*count, false);
        }
    }
